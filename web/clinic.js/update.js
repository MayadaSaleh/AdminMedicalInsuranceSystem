...
function dispalyClinic() {
    ...
    console.log(c);
    $.ajax({
        url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/details/get/?tid=2&sid=' + c,
        method: 'get',
        data: {},
        dataType: 'json',
...
function updateClinic(doctorNameAr, doctorNameEn, address, longitude, latitude, startDate, endDate, openHour, closeHour, specialization, phones, image) {
    ...
    $.ajax({
        url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/clinic/update',
        type: 'PUT',
