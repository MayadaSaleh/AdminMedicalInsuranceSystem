...
function findAll() {
    $.ajax({
        type: 'GET',
        url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/clinic/getAll',
        dataType: 'json',
...
function addClinic(doctorNameAr, doctorNameEn, address, longitude, latitude, startDate, endDate, openHour, closeHour, specialization, phones, image) {
    ...
    $.ajax({
        ...
        url: "http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/clinic/insert",
        dataType: "json",
        headers: {
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            window.location.href = "http://192.168.1.8:8084/AdminMedicalInsuranceSystem/clinic.html/getAllClinics.html"
...
function deleteClinic() {
    ...
    if (result) {
        ...
        $.ajax({
            url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/clinic/delete/' + requestData,
            type: 'DELETE',
            data: {},
            dataType: 'json',
