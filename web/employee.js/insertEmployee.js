...
function insertEmployeeInCompany(requestEmail,requestName,requestAddress,requestPassword,requestJob,requestImage,requestCompanyID,requestStartDate,requestEndDate,requestPackageType,requestPhone1) {
        ...
        $.ajax({
            url: 'http://192.168.137.1:8084/MedicalInsuranceSystem/api/version1/user/insertEmployee',
            type: 'POST',
            ...
            success: function (response) {
                ...
                window.location.href = "http://192.168.137.1:8084/AdminMedicalInsuranceSystem/company.html/SpecificCompany.html?companyId=" + requestCompanyID;
