...
function dispalyPharmacy() {
    ...
    console.log(c);
    $.ajax({
        url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/details/get/?tid=3&sid=' + c,
        method: 'get',
        data: {},
        dataType: 'json',
...
function  updatePharmacy(nameAr, nameEn, address, longitude, latitude, startDate, endDate, openHour, closeHour, phones, image) {
    ...
    $.ajax({
        url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/pharmacy/update',
        type: 'PUT',
        ...
        success: function (response) {
            ...
            window.location.href = "http://192.168.1.8:8084/AdminMedicalInsuranceSystem/pharmacy/perService.html";
        },
        error: function (err) {
        }
    });
