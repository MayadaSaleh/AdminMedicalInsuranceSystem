...
function dispalyHospital() {
    ...
    $.ajax({
        url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/details/get?tid=1&sid=' + c,
        method: 'get',
        data: {},
        dataType: 'json',
...
function updateHospital(nameAr, nameEn, address, longitude, latitude, startDate, endDate, openHour, closeHour, ceo, phones, departments, image)
{
    ...
    $.ajax({
        url: 'http://192.168.1.8:8084/MedicalInsuranceSystem/api/version1/hospital/update',
        type: 'PUT',
